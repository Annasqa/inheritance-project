 ...
 *
 *
 *        Create the following class structure: IAnimal (method makeNoise) which
 *        is an interface used by Animal subclasses of Cat, Bird, Fish,
...
public class Zoo {
	...
	private void setupAnimals() {
		IZooAnimal[] myZooAnimal = { new Lion(), new Tiger(), new Whale(), new Parrot(), new Penguin(),
				new KillerShark() };
		this.zooAnimals = myZooAnimal;
